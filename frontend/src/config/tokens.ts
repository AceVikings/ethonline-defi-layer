...
export const POPULAR_TOKENS = {
  // Base Mainnet
  base: [
    { symbol: 'ETH', name: 'Ethereum', address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', decimals: 18 }, // Native ETH
  ...
  // Celo Mainnet
  celo: [
    { symbol: 'CELO', name: 'Celo', address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', decimals: 18 },
  ...
  basesepolia: [
    { symbol: 'ETH', name: 'Ethereum', address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', decimals: 18 },
    { symbol: 'WETH', name: 'Wrapped Ether', address: '0x4200000000000000000000000000000000000006', decimals: 18 },
    { symbol: 'USDC', name: 'USD Coin (Mock)', address: '0x036CbD53842c5426634e7929541eC2318f3dCF7e', decimals: 6 },
  ],
  ...
  avalanchefuji: [
    { symbol: 'AVAX', name: 'Avalanche', address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', decimals: 18 },
    { symbol: 'WAVAX', name: 'Wrapped AVAX', address: '0xd00ae08403B9bbb9124bB305C09058E32C39A48c', decimals: 18 },
  ],

  // Polygon Mumbai Testnet
  polygonmumbai: [
    { symbol: 'MATIC', name: 'Polygon', address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', decimals: 18 },
    { symbol: 'WMATIC', name: 'Wrapped Matic', address: '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', decimals: 18 },
  ],
};
